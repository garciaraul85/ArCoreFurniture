...
public class CustomOnGestureListener implements OnGestureListener,
    ...
    public LinkedHashMap<Long, Integer> nodeList = new LinkedHashMap<>();
    ...
    public boolean onDoubleTap(MotionEvent e) {
        ...
        if (mCurrentDownEvent.getPointerCount() == 1) {
            System.out.println("onDoubleTap() ptrs:" + mCurrentDownEvent.getPointerCount());
    ...
    public boolean onDoubleTapConfirmed(MotionEvent e) {
        System.out.println("onDoubleTapConfirmed() ptrs:" + e.getPointerCount());

        if (mPtrCount == 1) {
            System.out.println("onDoubleTapConfirmed(): tap and a half");
        }
        return true;
    }
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        if (!mHandler.hasMessages(TAP)
            ...
            System.out.println("onSingleTapConfirmed() ptrs:" + e.getPointerCount());

        if (mPtrCount == 1 && mCurrentDownEvent.getPointerCount() == 2) {
            // one finger is still down and a single tap occured
            System.out.println("onSingleTapConfirmed(): One finger down, one finger tap");
        }
        return true;
    }
    ...
    public void onLongPress(MotionEvent e) {
        System.out.println("_xyz onLongPress() nodeList:" + nodeList);
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
        ...
        System.out.println("onScroll() ptrs:e1:" + e1.getPointerCount() + " e2:"
                + e2.getPointerCount() + " ptrCnt: " + mPtrCount);

        boolean scroll = isScrollGesture(e2);
        boolean pinch = isPinchGesture(e2);

        System.out.println("onScroll() scroll = " + scroll + " pinch = " + pinch);
